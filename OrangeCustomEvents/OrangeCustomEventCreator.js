...
(function($) {
  ...
  function createParallelProcess(scriptOrCommonEventId, temporary, autoErase) {
    ...
    $gameMap.addEventAt(eventData, temporary);
  }
  ...
  Game_Map.prototype.addEvent = function(eventData, temporary) {
    ...
    oldGameMap_addEvent.call(this, eventData, temporary);
  };
...
PluginManager.register("OrangeCustomEventCreator", "1.0.0", "Will let you create virtual events with script calls", {
